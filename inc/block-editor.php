...
add_action( 'after_setup_theme', 'wss_block_editor_setup' );

if ( ! function_exists( 'wss_block_editor_setup' ) ) {

	/**
	 * Sets up our default theme support for the WordPress block editor.
	 */
	function wss_block_editor_setup() {
		...
		$color_palette = wss_generate_color_palette();
		if ( $color_palette ) {
...
if ( ! function_exists( 'wss_generate_color_palette' ) ) {
	/**
	 * Checks for our JSON file of color values. If exists, creates a color palette array.
	 *
	 * @return array|bool
	 */
	function wss_generate_color_palette() {
		$color_palette = array();
		 ...
		 */
		return apply_filters( 'wss_theme_editor_color_palette', $color_palette );
	}
}
