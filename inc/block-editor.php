...
add_action( 'after_setup_theme', 'wssbase_block_editor_setup' );

if ( ! function_exists( 'wssbase_block_editor_setup' ) ) {

	/**
	 * Sets up our default theme support for the WordPress block editor.
	 */
	function wssbase_block_editor_setup() {
		...
		$color_palette = wssbase_generate_color_palette();
		if ( $color_palette ) {
...
if ( ! function_exists( 'wssbase_generate_color_palette' ) ) {
	/**
	 * Checks for our JSON file of color values. If exists, creates a color palette array.
	 *
	 * @return array|bool
	 */
	function wssbase_generate_color_palette() {
		$color_palette = array();
		 ...
		 */
		return apply_filters( 'wssbase_theme_editor_color_palette', $color_palette );
	}
}
